...
FIRST_CHAR_1040 = 0x410  # 'А'
OLDFONT_1040 = bytes((
    3, 0x1E, 0x05, 0x1E, # 0x410 'A'
    3, 0b00011111, 0b00010101, 0b00001001, # 0x411 'Б'
    3, 0x1F, 0x15, 0x0A, # 0x412 'В'
    3, 0b00011111, 0b00000001, 0b00000001, # 0x413 'Г'
    3, 0b00011110, 0b00001001, 0b00011111, # 0x414 'Д'
    3, 0x1F, 0x15, 0x11, # 0x415 'Е'
    3, 0b00011011, 0b00011111, 0b00011011, # 0x416 'Ж'
    3, 0b00010001, 0b00010101, 0b00001010, # 0x417 'З'
    3, 0b00011111, 0b00000110, 0b00011111, # 0x418 'И'
    3, 0b00011101, 0b00001010, 0b00011101, # 0x419 'Й'
    3, 0x1F, 0x06, 0x19, # 0x41A 'К'
    3, 0b00011100, 0b00000011, 0b00011111, # 0x41B 'Л'
    3, 0x1F, 0x03, 0x1F, # 0x41C 'М'
    3, 0x1F, 0x04, 0x1F, # 0x41D 'Н'
    3, 0x1F, 0x11, 0x1F, # 0x41E 'О'
    3, 0b00011111, 0b00000001, 0b00011111, # 0x41F 'П'
    3, 0x1F, 0x05, 0x02, # 0x420 'Р'
    3, 0x0E, 0x11, 0x11, # 0x421 'С'
    3, 0x01, 0x1F, 0x01, # 0x422 'Т'
    3, 0b00010011, 0b00001100, 0b00000011, # 0x423 'У'
    3, 0b00001110, 0b00011111, 0b00001110, # 0x424 'Ф'
    3, 0x1B, 0x04, 0x1B, # 0x425 'Х'
    3, 0b00001111, 0b00001000, 0b00011111, # 0x426 'Ц'
    3, 0b00000111, 0b00000100, 0b00011111, # 0x427 'Ч'
    3, 0b00011111, 0b00011000, 0b00011111, # 0x428 'Ш'
    3, 0b00001111, 0b00001100, 0b00011111, # 0x429 'Щ'
    3, 0b00000001, 0b00011111, 0b00011000, # 0x42A 'Ъ'
    3, 0b00011111, 0b00010100, 0b00011111, # 0x42B 'Ы'
    3, 0b00011111, 0b00010100, 0b00001000, # 0x42C 'Ь'
    3, 0b00010001, 0b00010101, 0b00001110, # 0x42D 'Э'
    3, 0b00011111, 0b00001010, 0b00001110, # 0x42E 'Ю'
    3, 0b00011010, 0b00000101, 0b00011111, # 0x42F 'Я'
    3, 0x0A, 0x1A, 0x1C, # 0x430 'а'
    3, 0b00001110, 0b00010101, 0b00001001, # 0x431 'б'
    3, 0b00011110, 0b00010110, 0b00001100, # 0x432 'в'
    3, 0b00011110, 0b00000010, 0b00000010, # 0x433 'г'
    3, 0b00011100, 0b00001010, 0b00011110, # 0x434 'д'
    3, 0x0C, 0x16, 0x16, # 0x435 'е'
    3, 0b00011010, 0b00011110, 0b00011010, # 0x436 'ж'
    3, 0b00010010, 0b00010110, 0b00001100, # 0x437 'з'
    3, 0b00011110, 0b00001100, 0b00011110, # 0x438 'и'
    3, 0b00011101, 0b00001010, 0b00011101, # 0x439 'й'
    3, 0b00011110, 0b00000100, 0b00011010, # 0x43A 'к'
    3, 0b00011000, 0b00000110, 0b00011110, # 0x43B 'л'
    3, 0b00011110, 0b00000110, 0b00011110, # 0x43C 'м'
    3, 0b00011110, 0b00000100, 0b00011110, # 0x43D 'н'
    3, 0x1E, 0x12, 0x1E, # 0x43E 'о'
    3, 0b00011110, 0b00000010, 0b00011110, # 0x43F 'п'
    3, 0x1E, 0x0A, 0x04, # 0x440 'р'
    3, 0x0C, 0x12, 0x12, # 0x441 'с'
    3, 0b00000010, 0b00011110, 0b00000010, # 0x442 'т'
    3, 0b00010110, 0b00001000, 0b00000110, # 0x443 'у'
    3, 0b00001100, 0b00011110, 0b00001100, # 0x444 'ф'
    3, 0x12, 0x0C, 0x12, # 0x445 'х'
    3, 0b00001110, 0b00001000, 0b00011110, # 0x446 'ц'
    3, 0b00000110, 0b00000100, 0b00011110, # 0x447 'ч'
    3, 0b00011110, 0b00011000, 0b00011110, # 0x448 'ш'
    3, 0b00001110, 0b00001100, 0b00011110, # 0x449 'щ'
    3, 0b00000010, 0b00011110, 0b00011000, # 0x44A 'ъ'
    3, 0b00011110, 0b00010100, 0b00011110, # 0x44B 'ы'
    3, 0b00011110, 0b00010100, 0b00001000, # 0x44C 'ь'
    3, 0b00010010, 0b00010110, 0b00001100, # 0x44D 'э'
    3, 0b00011110, 0b00001010, 0b00001100, # 0x44E 'ю'
    3, 0b00010100, 0b00001010, 0b00011110, # 0x44F 'я'
    3, 0b00001101, 0b00010110, 0b00010110, # 0x450 'ѐ'
    3, 0b00001101, 0b00010110, 0b00010111, # 0x451 'ё'
    3, 0b00001111, 0b00000100, 0b00011000, # 0x452 'ђ'
    3, 0b00011100, 0b00000100, 0b00000101, # 0x453 'ѓ'
    3, 0b00001100, 0b00010110, 0b00010010, # 0x454 'є'
    3, 0x14, 0x1A, 0x0A, # 0x455 'ѕ'
    1, 0b00011101, 0b00000000, 0b00000000, # 0x456 'і'
    3, 0b00000001, 0b00011101, 0b00000001, # 0x457 'ї'
    2, 0x10, 0x1D, 0x00, # 0x458 'ј'
    3, 0b00011100, 0b00011110, 0b00010000, # 0x459 'љ'
    3, 0b00011110, 0b00011110, 0b00001000, # 0x45A 'њ'
    3, 0b00011111, 0b00001010, 0b00010000, # 0x45B 'ћ'
    3, 0b00011100, 0b00001000, 0b00010101, # 0x45C 'ќ'
    3, 0b00011101, 0b00001000, 0b00011100, # 0x45D 'ѝ'
    3, 0b00011101, 0b00001001, 0b00000101, # 0x45E 'ў'
    3, 0b00001110, 0b00011000, 0b00001110  # 0x45F 'џ'
))

FIRST_CHAR_8208 = 0x2010  # '‐'
OLDFONT_8208 = bytes((
...
struct['←'] = (4, 5, -5, [0b00100100, 0b11110100, 0b00100000]) # left arrow
struct['↑'] = (5, 5, -5, [0b00100011, 0b10101010, 0b01000010, 0b00000000]) # up arrow
struct['→'] = (4, 5, -5, [0b01000010, 0b11110010, 0b01000000]) # right arrow
struct['↓'] = (5, 5, -5, [0b00100001, 0b00101010, 0b11100010, 0b00000000]) # down arrow
...
struct['¹'] = (2, 4, -6, [0b01110101]) # superscript one
struct['º'] = (3, 4, -6, [0b01010101, 0b01110000]) # masculine ordinal indicator
struct['»'] = (4, 3, -4, [0b10100101, 0b10100000]) # right double angle quotation mark
struct['«'] = (4, 3, -4, [0b01011010, 0b01010000]) # right double angle quotation mark
struct['¼'] = (4, 6, -6, [0b10001010, 0b01001010, 0b00110001]) # vulgar fraction one quarter
struct['½'] = (4, 7, -6, [0b10001010, 0b01001011, 0b00010010, 0b00110000]) # vulgar fraction one half
struct['¾'] = (6, 6, -6, [0b11000001, 0b00001101, 0b00001010, 0b01001100, 0b00010000]) # vulgar fraction three quarters
struct['À'] = (3, 6, -6, [0b10001010, 0b11111011, 0b01000000]) # A with grave
struct['Á'] = (3, 6, -6, [0b00101010, 0b11111011, 0b01000000]) # A with acute
struct['Â'] = (3, 6, -6, [0b01010101, 0b01011111, 0b01000000]) # A with circumflex
struct['Ã'] = (3, 6, -6, [0b11101010, 0b11111011, 0b01000000]) # A with tilde
struct['Ä'] = (3, 6, -6, [0b10101010, 0b11111011, 0b01000000]) # A with diaeresis
struct['Å'] = (3, 6, -6, [0b01010101, 0b01011111, 0b01000000]) # A with ring above
struct['Æ'] = (4, 5, -5, [0b01111010, 0b11111010, 0b10110000]) # AE ligature
struct['Ç'] = (3, 6, -5, [0b01110010, 0b01000110, 0b10000000]) # C with cedilla
struct['È'] = (3, 6, -6, [0b10011110, 0b01111001, 0b11000000]) # E with grave
struct['É'] = (3, 6, -6, [0b00111110, 0b01111001, 0b11000000]) # E with acute
struct['Ê'] = (3, 6, -6, [0b01010111, 0b11101001, 0b11000000]) # E with circumflex
struct['Ë'] = (3, 6, -6, [0b10100011, 0b11101001, 0b11000000]) # E with diaeresis
struct['Ì'] = (3, 6, -6, [0b10001011, 0b10100101, 0b11000000]) # I with grave
struct['Í'] = (3, 6, -6, [0b00101011, 0b10100101, 0b11000000]) # I with acute
struct['Î'] = (3, 6, -6, [0b01010100, 0b01110101, 0b11000000]) # I with circum
struct['Ï'] = (3, 6, -6, [0b10100011, 0b10100101, 0b11000000]) # I with diaeresis
struct['Ñ'] = (3, 6, -6, [0b11100011, 0b01011011, 0b01000000]) # N with tilde
struct['Ò'] = (3, 6, -6, [0b10001011, 0b11011011, 0b11000000]) # O with grave
struct['Ó'] = (3, 6, -6, [0b00101011, 0b11011011, 0b11000000]) # O with acute
struct['Ô'] = (3, 6, -6, [0b01010100, 0b01111011, 0b11000000]) # O with circumflex
struct['Õ'] = (3, 6, -6, [0b11100011, 0b11011011, 0b11000000]) # O with tilde
struct['Ö'] = (3, 6, -6, [0b10100011, 0b11011011, 0b11000000]) # O with diaeresis
struct['Ù'] = (3, 6, -6, [0b10001000, 0b01011010, 0b11000000]) # U with grave
struct['Ú'] = (3, 6, -6, [0b00101000, 0b01011010, 0b11000000]) # U with acute
...
struct['Ý'] = (3, 6, -6, [0b00101000, 0b01010100, 0b10000000]) # Y with acute

struct['à'] = (3, 6, -6, [0b10001011, 0b00011110, 0b11000000]) # a with grave
struct['á'] = (3, 6, -6, [0b00101011, 0b00011110, 0b11000000]) # a with acute
struct['â'] = (3, 6, -6, [0b01010111, 0b00011110, 0b11000000]) # a with circumflex
struct['ã'] = (3, 6, -6, [0b11100011, 0b00011110, 0b11000000]) # a with tilde
struct['ä'] = (3, 6, -6, [0b10100011, 0b00011110, 0b11000000]) # a with diaeresis
struct['å'] = (3, 6, -6, [0b01010101, 0b01110110, 0b11000000]) # a with ring above
struct['æ'] = (4, 4, -4, [0b11110011, 0b11001111]) # ae ligature
struct['ç'] = (3, 5, -4, [0b01110010, 0b00110100]) # c with cedilla
struct['è'] = (3, 6, -6, [0b10001001, 0b11111000, 0b11000000]) # e with grave
struct['é'] = (3, 6, -6, [0b00101001, 0b11111000, 0b11000000]) # e with acute
struct['ê'] = (3, 6, -6, [0b01010101, 0b11111000, 0b11000000]) # e with circumflex
struct['ë'] = (3, 6, -6, [0b10100001, 0b11111000, 0b11000000]) # e with diaeresis
struct['ì'] = (2, 6, -6, [0b10010001, 0b01010000]) # i with grave
struct['í'] = (2, 6, -6, [0b01100010, 0b10100000]) # i with acute
struct['î'] = (3, 6, -6, [0b01010100, 0b00100100, 0b10000000]) # i with circumflex
struct['ñ'] = (3, 6, -6, [0b11100011, 0b01011011, 0b01000000]) # n with tilde
struct['ò'] = (3, 6, -6, [0b10001000, 0b01111011, 0b11000000]) # o with grave
struct['ó'] = (3, 6, -6, [0b00101000, 0b01111011, 0b11000000]) # o with acute
struct['ô'] = (3, 6, -6, [0b01010100, 0b01111011, 0b11000000]) # o with circumflex
struct['õ'] = (3, 6, -6, [0b11100011, 0b11011011, 0b11000000]) # o with tilde
struct['ö'] = (3, 6, -6, [0b10100011, 0b11011011, 0b11000000]) # o with diaeresis
struct['ù'] = (3, 6, -6, [0b10001000, 0b01011010, 0b11000000]) # u with grave
...
struct['ă'] = (3, 6, -6, [0b10101011, 0b00011110, 0b11000000]) # a with breve
struct['Ą'] = (3, 6, -5, [0b01010111, 0b11011010, 0b01000000]) # A with ogonek
struct['ą'] = (3, 5, -4, [0b11000111, 0b10110010]) # a with ogonek
struct['Ć'] = (3, 6, -6, [0b00101001, 0b11001000, 0b11000000]) # C with acute
struct['ć'] = (3, 6, -6, [0b00101000, 0b00111000, 0b11000000]) # c with acute
struct['Ĉ'] = (3, 6, -6, [0b01010101, 0b11001000, 0b11000000]) # C with circumflex
struct['ĉ'] = (3, 6, -6, [0b01010100, 0b00111000, 0b11000000]) # c with circumflex
struct['Ċ'] = (3, 6, -6, [0b01000001, 0b11001000, 0b11000000]) # C with dot above
struct['ċ'] = (3, 6, -6, [0b01000001, 0b11001000, 0b11000000]) # c with dot above
struct['Č'] = (3, 6, -6, [0b10101001, 0b11001000, 0b11000000]) # C with caron
struct['č'] = (3, 6, -6, [0b10101000, 0b00111000, 0b11000000]) # c with caron
struct['Ď'] = (3, 6, -6, [0b10101011, 0b01011011, 0b10000000]) # D with caron
struct['ď'] = (4, 5, -5, [0b01010101, 0b11001100, 0b11000000]) # d with caron
struct['Đ'] = (4, 5, -5, [0b01100101, 0b11010101, 0b01100000]) # D with stroke
struct['đ'] = (4, 5, -5, [0b00100011, 0b01101010, 0b01100000]) # d with stroke
struct['Ē'] = (3, 6, -6, [0b11100011, 0b11101001, 0b11000000]) # E with macron
struct['ē'] = (3, 6, -6, [0b11100001, 0b11111000, 0b11000000]) # e with macron
struct['Ĕ'] = (3, 6, -6, [0b10101011, 0b11101001, 0b11000000]) # E with breve
struct['ĕ'] = (3, 6, -6, [0b10101001, 0b11111000, 0b11000000]) # e with breve
struct['Ė'] = (3, 6, -6, [0b01000011, 0b11101001, 0b11000000]) # E with dot above
struct['ė'] = (3, 6, -6, [0b01000001, 0b11111000, 0b11000000]) # e with dot above
struct['Ę'] = (3, 6, -5, [0b11110011, 0b01001110, 0b10000000]) # E with ogonek
struct['ę'] = (3, 5, -4, [0b01111110, 0b00110100]) # e with ogonek
struct['Ě'] = (3, 6, -6, [0b10101011, 0b11101001, 0b11000000]) # E with caron
struct['ě'] = (3, 6, -6, [0b10101001, 0b11111000, 0b11000000]) # e with caron
struct['Ĝ'] = (3, 6, -6, [0b01010101, 0b11001010, 0b11000000]) # G with circumflex
struct['ĝ'] = (3, 7, -6, [0b01010100, 0b00111110, 0b01011000]) # g with circumflex
struct['Ğ'] = (3, 6, -6, [0b10101001, 0b11001010, 0b11000000]) # G with breve
struct['ğ'] = (3, 7, -6, [0b10101000, 0b00111110, 0b01011000]) # g with breve
struct['Ġ'] = (3, 6, -6, [0b01000001, 0b11001010, 0b11000000]) # G with dot above
struct['ġ'] = (3, 7, -6, [0b01000001, 0b11011110, 0b01011000]) # g with dot above
struct['Ģ'] = (3, 6, -5, [0b01110010, 0b11010110, 0b10000000]) # G with cedilla
struct['ģ'] = (3, 7, -6, [0b00101000, 0b00111110, 0b01011000]) # g with cedilla
struct['Ĥ'] = (3, 6, -6, [0b01010100, 0b01011111, 0b01000000]) # H with circumflex
struct['ĥ'] = (3, 6, -6, [0b01010100, 0b01001101, 0b01000000]) # h with circumflex
struct['Ĩ'] = (3, 6, -6, [0b11100011, 0b10100101, 0b11000000]) # I with tilde
struct['ĩ'] = (3, 5, -5, [0b11100001, 0b00101000]) # i with tilde
struct['Ī'] = (3, 6, -6, [0b11100011, 0b10100101, 0b11000000]) # I with macron
struct['ī'] = (3, 6, -6, [0b11100001, 0b00101000, 0b11000000]) # i with macron
struct['Ĭ'] = (3, 6, -6, [0b10101000, 0b01110101, 0b11000000]) # I with breve
struct['ĭ'] = (3, 6, -6, [0b10101000, 0b00100100, 0b10000000]) # i with breve
struct['Į'] = (3, 6, -5, [0b11101001, 0b00101110, 0b10000000]) # I with ogonek
struct['į'] = (1, 6, -5, [0b10111100]) # i with ogonek
struct['İ'] = (3, 6, -6, [0b01000011, 0b10100101, 0b11000000]) # I with dot above
...
struct['ĺ'] = (2, 6, -6, [0b01100010, 0b10010000]) # l with acute
struct['Ļ'] = (3, 6, -5, [0b10010010, 0b01001110, 0b10000000]) # L with cedilla
struct['ļ'] = (2, 6, -5, [0b10101010, 0b01100000]) # l with cedilla
struct['Ľ'] = (3, 6, -6, [0b00110110, 0b01001001, 0b11000000]) # L with caron
struct['ľ'] = (3, 6, -6, [0b00110110, 0b01001000, 0b10000000]) # l with caron
struct['Ł'] = (4, 5, -5, [0b01000110, 0b11000100, 0b01110000]) # L with stroke
struct['ł'] = (3, 5, -5, [0b01001111, 0b00100010]) # l with stroke
struct['Ń'] = (3, 6, -6, [0b00101011, 0b01011011, 0b01000000]) # N with acute
struct['ń'] = (3, 6, -6, [0b00101000, 0b01101011, 0b01000000]) # n with acute
struct['Ņ'] = (3, 6, -5, [0b11010110, 0b11011010, 0b10000000]) # N with cedilla
struct['ņ'] = (3, 5, -4, [0b11010110, 0b11010100]) # n with cedilla
struct['Ň'] = (3, 6, -6, [0b10101011, 0b01011011, 0b01000000]) # N with caron
struct['ň'] = (3, 6, -6, [0b10101000, 0b01101011, 0b01000000]) # n with caron
struct['ŉ'] = (4, 6, -6, [0b10001000, 0b01100101, 0b01010101]) # n apostrophe
struct['Ŋ'] = (3, 6, -5, [0b11010110, 0b11011010, 0b01000000]) # Eng
struct['ŋ'] = (3, 5, -4, [0b11010110, 0b11010100]) # eng
struct['Ō'] = (3, 6, -6, [0b11100011, 0b11011011, 0b11000000]) # O with macron
struct['ō'] = (3, 6, -6, [0b11100011, 0b11011011, 0b11000000]) # o with macron
struct['Ŏ'] = (3, 6, -6, [0b10101011, 0b11011011, 0b11000000]) # O with breve
struct['ŏ'] = (3, 6, -6, [0b10101000, 0b01111011, 0b11000000]) # o with breve
struct['Ő'] = (3, 6, -6, [0b10100011, 0b11011011, 0b11000000]) # O with double acute
struct['ő'] = (3, 6, -6, [0b10100011, 0b11011011, 0b11000000]) # o with double acute
struct['Œ'] = (4, 5, -5, [0b01111010, 0b10111010, 0b01110000]) # OE ligature
struct['œ'] = (4, 4, -4, [0b01111011, 0b10100111]) # oe ligature
struct['Ŕ'] = (3, 6, -6, [0b00101011, 0b01011101, 0b01000000]) # R with acute
struct['ŕ'] = (3, 6, -6, [0b00101000, 0b00111001, 0b00000000]) # r with acute
struct['Ŗ'] = (3, 6, -5, [0b11010111, 0b01011010, 0b10000000]) # R with cedilla
struct['ŗ'] = (3, 5, -4, [0b01110010, 0b01000100]) # r with cedilla
struct['Ř'] = (3, 6, -6, [0b10101011, 0b01011101, 0b01000000]) # R with caron
struct['ř'] = (3, 6, -6, [0b10101000, 0b00111001, 0b00000000]) # r with car
struct['Ś'] = (3, 6, -6, [0b00101001, 0b11100011, 0b10000000]) # S with acute
struct['ś'] = (3, 6, -6, [0b00101001, 0b11100011, 0b10000000]) # s with acute
struct['Ŝ'] = (3, 6, -6, [0b01010101, 0b11100011, 0b10000000]) # S with circumflex
struct['ŝ'] = (3, 6, -6, [0b01010101, 0b11100011, 0b10000000]) # s with circum
struct['Ş'] = (3, 6, -5, [0b01110001, 0b00011100, 0b10000000]) # S with cedilla
struct['ş'] = (3, 5, -4, [0b01111000, 0b11100100]) # s with cedilla
struct['Š'] = (3, 6, -6, [0b10101001, 0b11100011, 0b10000000]) # S with acute
struct['š'] = (3, 6, -6, [0b10101001, 0b11100011, 0b10000000]) # s with acute
struct['Ţ'] = (3, 6, -5, [0b11101001, 0b00100100, 0b10000000]) # T with cedilla
struct['ţ'] = (3, 6, -5, [0b01011101, 0b00100010, 0b10000000]) # t with cedilla
...
struct['ŭ'] = (3, 6, -6, [0b10101000, 0b01011010, 0b11000000]) # u with breve
struct['Ů'] = (3, 6, -6, [0b01010101, 0b01011010, 0b11000000]) # U with ring above
struct['ů'] = (3, 6, -6, [0b01010101, 0b00001010, 0b11000000]) # u with ring
struct['Ű'] = (3, 6, -6, [0b10100010, 0b11011010, 0b11000000]) # U with double acute
struct['ű'] = (3, 6, -6, [0b10100010, 0b11011010, 0b11000000]) # u with double acute
...
struct['Ź'] = (3, 6, -6, [0b00101011, 0b10010101, 0b11000000]) # Z with acute
struct['ź'] = (3, 6, -6, [0b00101011, 0b10010101, 0b11000000]) # z with acute
struct['Ż'] = (3, 6, -6, [0b01000011, 0b10010101, 0b11000000]) # Z with dot above
struct['ż'] = (3, 6, -6, [0b01000011, 0b10010101, 0b11000000]) # z with dot above
struct['Ž'] = (3, 6, -6, [0b10101011, 0b10010101, 0b11000000]) # Z with caron
struct['ž'] = (3, 6, -6, [0b10101011, 0b10010101, 0b11000000]) # z with caron

struct['Д'] = (3, 6, -5, [0b01110110, 0b11011111, 0b01000000]) # Cyrillic De
struct['Ж'] = (5, 5, -5, [0b10101101, 0b01011101, 0b01011010, 0b10000000]) # Cyrillic Zhe
struct['Ц'] = (4, 6, -5, [0b10101010, 0b10101010, 0b11110001]) # Cyrillic Tse
struct['Щ'] = (4, 6, -5, [0b10101110, 0b11101110, 0b11110001]) # Cyrillic Shcha
struct['Ю'] = (4, 5, -5, [0b10101101, 0b11011101, 0b10100000]) # Cyrillic Yu
struct['д'] = (3, 5, -4, [0b01110110, 0b11111010]) # Cyrillic de
struct['ж'] = (5, 4, -4, [0b10101011, 0b10011101, 0b01010000]) # Cyrillic zhe
struct['ц'] = (4, 5, -4, [0b10101010, 0b10101111, 0b00010000]) # Cyrillic tse
struct['щ'] = (4, 5, -4, [0b10101110, 0b11101111, 0b00010000]) # Cyrillic shcha
struct['ю'] = (4, 4, -4, [0b10101101, 0b11011010]) # Cyrillic yu
struct['ѓ'] = (3, 6, -6, [0b00101000, 0b01111001, 0b00100000]) # Cyrillic gje
struct['љ'] = (4, 4, -4, [0b01100110, 0b10111011]) # Cyrillic lje
struct['њ'] = (4, 4, -4, [0b10101110, 0b10111011]) # Cyrillic nje
...
struct['‱'] = (5, 5, -5, [0b10000001, 0b00010001, 0b00000011, 0b10000000]) # basis point sign
struct['‴'] = (5, 2, -5, [0b11001100, 0b11000000]) # triple prime
struct['‷'] = (5, 2, -5, [0b11001100, 0b11000000]) # quintuple prime
struct['⁇'] = (5, 5, -5, [0b10010010, 0b01100100, 0b00001001, 0b00000000]) # double question mark
struct['⁈'] = (4, 5, -5, [0b10010101, 0b10010000, 0b10010000]) # question exclamation mark
struct['⁉'] = (4, 5, -5, [0b10101001, 0b10100000, 0b10100000]) # exclamation question mark
struct['⁑'] = (3, 7, -6, [0b10101010, 0b10001010, 0b10101000]) # asterism
struct['⁓'] = (4, 2, -3, [0b01011010]) # swung dash
struct['⁗'] = (7, 2, -5, [0b10101011, 0b01010100]) # quadruple prime

struct['🇶'] = (3, 6, -5, [0b11110110, 0b11011110, 0b01000000])
